# based on (origin): http://www.cyberforum.ru/blogs/27546/blog4812.html
...
public class NetworkSTAT {
	...
	// MIB_TCPROW_OWNER_PID holds an TCP connection info
	...
	// MIB_UDPROW_OWNER_PID holds an UDP connection info
	[StructLayout(LayoutKind.Sequential)]
	...
	public static Connection[] GetTCP() {
		...
		try {
			...
			tab = (MIB_TCPTABLE_OWNER_PID)Marshal.PtrToStructure(buffTable, typeof(MIB_TCPTABLE_OWNER_PID));
