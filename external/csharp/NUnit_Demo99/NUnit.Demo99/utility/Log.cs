...
namespace NUnit.Demo99.utility
{
	public class Log
	{
		// TODO: find the proper version of the ExtentReports package
		// public static ExtentReports _extent = new ExtentReports(config.Constants.Path_Report, DisplayOrder.NewestFirst);
		public static ExtentReports _extent = new ExtentReports(config.Constants.Path_Report, false);
		...
		public static void getTest()
		{
			if (_test == null) {
				...
				// TODO:  'RelevantCodes.ExtentReports.ExtentReports' 2.0.1 does not contain a definition for 'LoadConfig'
