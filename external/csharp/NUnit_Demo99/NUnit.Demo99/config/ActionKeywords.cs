...
namespace NUnit.Demo99.config
{
	class Methods
	{
		...
		public int AddNumb(Dictionary<String,String> param)
		{
			String data;
			try {
				param.TryGetValue("1", out data);
				num1 = Int32.Parse(data);
				param.TryGetValue("2", out data);
				num2 = Int32.Parse(data);
	...
	public class ActionKeywords
	{
		...
		public static void openBrowser(String obj, String data)
		{
			...
			object methodObj = Activator.CreateInstance(methodType);
			Dictionary<String,String> methodParam = new Dictionary<String,String>();
			methodParam.Add("1", "1");
			methodParam.Add("2", "2");
			int res = (int)methodType.InvokeMember("AddNumb", BindingFlags.InvokeMethod,
				          null, methodObj, new Object[]{ (Object)methodParam });
