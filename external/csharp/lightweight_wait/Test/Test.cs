...
namespace WaitTest {
	public class Test {
		...
		public static void Main() {
			...
			startTick = Environment.TickCount;
			try {
				Wait.Wait.Until(predicate2, 5000);
			...
			startTick = Environment.TickCount;
			string fromUntilString = Wait.Wait.UntilString(getNumberString, "Five");
			...
			number = 1;
			startTick = Environment.TickCount;
			fromUntilString = Wait.Wait.UntilContains(getNumberString, "F"); //"Four" or "Five"
