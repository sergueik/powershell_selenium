...
namespace Splunk.Client.Helpers
{
    ...
    public class MockContext : Context
    {
        ...
        {
            Splunk.Client.Contract.Requires<ArgumentNullException>(callerId != null);
        ...
        class Recording
        {
            ...
            {
                Splunk.Client.Contract.Requires<ArgumentNullException>(response != null);
                Splunk.Client.Contract.Requires<ArgumentNullException>(content != null);
                Splunk.Client.Contract.Requires<ArgumentNullException>(checksum != null);
