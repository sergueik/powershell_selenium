...
if __name__ == '__main__':
  try:
    ...
    print('usage: page_scale.py --scale <scale> --url <url>')
    print(str(err))
    exit()
  ...
  for option, argument in opts:
    if option == '-d':
      ...
      print ('usage: page_scale.py --url <html page> --scale <scale>')
      # e.g. python3 page_scale.py  --url https://www.google.com/maps --scale 1.25
